    ...
    <div x-data="{showMenu: false}" class="flex items-center">
      ...
      <div x-show="showMenu" class="fixed inset-0 w-full h-full bg-white z-50 text-yellow-900" style="display: none;">
        <div class="container h-full mx-auto px-6 py-8 relative z-10 flex flex-col items-center justify-center text-2xl uppercase font-bold tracking-widest space-y-6">
          ...
          <a href="#" class="inline-block border-b-4 border-transparent hover:border-yellow-900">About</a>
          <a href="#" class="inline-block border-b-4 border-transparent hover:border-yellow-900">Blog</a>
          <a href="#" class="inline-block border-b-4 border-transparent hover:border-yellow-900">Contact</a>
        </div>
